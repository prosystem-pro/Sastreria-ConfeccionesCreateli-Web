...
export class AlertaServicio {
  ...
  PedirTexto(titulo: string, texto: string = '', placeholder: string = 'Escriba aquí...', confirmText: string = 'Aceptar', cancelText: string = 'Cancelar'): Promise<string | null> {
    return Swal.fire({
      title: titulo,
      text: texto,
      input: 'text',
      ...
      inputValidator: (valor) => {
        if (!valor) return 'Debe ingresar la clave';
        return null;
      }
